  ...
  mr = function (a, b, c, d) {
    ...
    var e = function (b) {
      b("body").hasClass("scroll-assist") && (a.scroll.assisted = !0), addEventListener("scroll", function (a) {
        ...
        mr.scroll.y = c.pageYOffset, mr.scroll.update(a)
      }, !1)
    };
    ...
    a.scroll.classModifiers = {}, a.scroll.classModifiers.rules = [], a.scroll.classModifiers.parseScrollRules = function (b) {
      ...
      for (var c, d = a.scroll.y, e = a.scroll.classModifiers.rules,
             f = e.length; f--;) c = e[f], d > c.scrollPoint && !c.hasClass && (c.element.classList.add(c.toggleClass), c.hasClass = a.scroll.classModifiers.rules[f].hasClass = !0), d < c.scrollPoint && c.hasClass && (c.element.classList.remove(c.toggleClass), c.hasClass = a.scroll.classModifiers.rules[f].hasClass = !1)
    };
    var e = function () {
    ...
    return a.cookies = {
      ...
      keys: function () {
        for (var a = d.cookie.replace(/((?:^|\s*;)[^\=]+)(?=;|$)|^\s*|\s*(?:\=[^;]*)?(?:\1|$)/g, "").split(/\s*(?:\=[^;]*)?;\s*/),
               b = a.length, c = 0; b > c; c++) a[c] = decodeURIComponent(a[c]);
        return a
      }
    }, a
  }(mr, jQuery, window, document), mr = function (a, b, c, d) {
    ...
    function e(a) {
      console.log(a(".dropdown__container").length);
    ...
    var g = function (b) {
      ...
      }), jQuery("body").append('<div class="container containerMeasure" style="opacity:0;pointer-events:none;"></div>'), a.dropdowns.done = !0), g === !1 ? e(b) : f(b), jQuery(c).resize(function () {
      })
    };
    ...
    return a.forms.documentReady = e, a.forms.submit = function (d) {
      ...
      if (a = b(a), a.find('.validate-required[type="checkbox"]').each(function () {
          ...
          "" === b(this).val() ? (b(this).addClass("field-error"), e = 1) : b(this).removeClass("field-error")
        }), a.find('.validate-email, .email, [name*="cm-"][type="email"]').each(function () {
          /(.+)@(.+){2,}\.(.+){2,}/.test(b(this).val()) ? b(this).removeClass("field-error") : (b(this).addClass("field-error"), e = 1)
        }), a.find(".validate-number-dash").each(function () {
          /^[0-9][0-9-]+[0-9]$/.test(b(this).val()) ? b(this).removeClass("field-error") : (b(this).addClass("field-error"), e = 1)
      ...
      a("[data-toggle-class]").each(function () {
        ...
        a(c).each(function () {
          ...
          2 === d.length && (f = d[0], e = d[1], a(c).on("click", function () {
            return c.hasClass("toggled-class") || c.toggleClass("toggled-class"), a(f).toggleClass(e), !1
          }))
        })
      })
    };
