 ...
 */
const rootRoute = {
  path: '/profil/sportif/animation/incentive',
  ...
  getIndexRoute(partialNextState, callback) {
    require.ensure([], function (require) {
      callback(null, {
        component: require('../../../../../containers/profil/sportif/intervention_entreprise_sportif/animation_incentive/ManagerAnimationIncentive').default,
      })
    })
  },
