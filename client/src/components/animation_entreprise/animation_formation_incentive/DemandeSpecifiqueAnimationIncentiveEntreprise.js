...
class DemandeSpecifiqueAnimationIncentiveEntreprise extends React.Component {
  constructor(props) {
    super(props);
  }
        ...
        <div className="col-md-12">
          <div className=" boxed boxed--lg boxed--border">
            <div className="panel panel-bordered">
              <h4>Demande d'animation incentive spécifique</h4>
...
export default connect()(DemandeSpecifiqueAnimationIncentiveEntreprise);