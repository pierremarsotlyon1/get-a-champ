...
!function (window, document, $) {
  ...
  $.site.menu = {
    ...
    init: function () {
      ...
      var that = this;
      $(document).arrive(".site-menubar-body", function () {
        // 'this' refers to the newly created element
        that.$instance = $(".site-menu");
        if (0 !== that.$instance.length) {
          that.bind();
        }
      });
    ...
    bind: function () {
      ...
      }).on("click", ".site-menu-item", function (e) {
        $(this).is(".has-sub") && $(e.target).closest(".site-menu-item").is(this) ? $(this).is(".open") ? $(this).trigger("close.site.menu") : $(this).trigger("open.site.menu") : $(this).is(".active") || ($(this).siblings(".active").trigger("deactive.site.menu"), $(this).trigger("active.site.menu"))
