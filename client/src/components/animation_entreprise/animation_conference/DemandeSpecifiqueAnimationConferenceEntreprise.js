...
class DemandeSpecifiqueAnimationConferenceEntreprise extends React.Component {
  constructor(props) {
    super(props);
  }
        ...
        <div className="col-md-12">
          <div className=" boxed boxed--lg boxed--border">
            <div className="panel panel-bordered">
                <h4>Demande d'animation de conférence spécifique</h4>
...
export default connect()(DemandeSpecifiqueAnimationConferenceEntreprise);