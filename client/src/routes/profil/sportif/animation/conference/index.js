 ...
 */
const rootRoute = {
  path: '/profil/sportif/animation/conference',
  ...
  getIndexRoute(partialNextState, callback) {
    require.ensure([], function (require) {
      callback(null, {
        component: require('../../../../../containers/profil/sportif/intervention_entreprise_sportif/animation_conference/ManagerAnimationConference').default,
      })
    })
  },
